...
func _ready() -> void:
	...
	if FileAccess.file_exists(SAVE_PATH):
		...
		print(save_manager.get_value("max_penguins"))
		player.max_penguins = (save_manager.get_value("max_penguins"))
...
func save_game():
	...
	save_manager.set_value("max_penguins", player.max_penguins)
